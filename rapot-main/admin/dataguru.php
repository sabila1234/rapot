                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <a class="btn btn-success" href="function/edit.php?id=<?php echo $data['nip']; ?>">Edit</a>
                                            <a class="btn btn-danger" href="function/hapus.php?id=<?php echo $data['nip']; ?>">Delete</a>
